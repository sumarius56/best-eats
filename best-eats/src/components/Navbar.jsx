  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-text-3xl lg:text-4xl px-2'>Best <span className='font-bold'>Eats</span> </h1>
    ...
    <AiOutlineClose onClick={()=>SetNav(!nav)} size={30} className='abolute right-4 top-4 cursor-pointer' />
